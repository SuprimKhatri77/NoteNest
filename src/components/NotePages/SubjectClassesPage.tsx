...
export default function SubjectClassesPage({ subjectClass, subjectName }: { subjectClass: SubjectClass[]; subjectName: string }) {
    return (
        <div className="container max-w-6xl mx-auto px-4 py-8">
            ...
            {subjectClass.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {subjectClass.map((cls) => (
                        <Link
                            href={`/notes/${subjectName}/${cls.name}`}
                            key={cls.id}
                        ...
                        >
                            ...
                            <p className="text-indigo-600 dark:text-indigo-300 text-sm">
                                Explore chapters and exam papers for this class
                            </p>
                        </Link>
                    ))}
                </div>
