    ...
    <>
      <section className="flex flex-col md:flex-row items-center py-10 px-3 md:px-10 mt-5 bg-white dark:bg-gray-800 mx-3 mb-8 rounded-2xl  md:mt-28 shadow relative  justify-center overflow-x-hidden">
        ...
        <div className="flex-1 pr-0 md:pr-16 relative z-10 mb-10 md:mb-0 text-center md:text-left">
          ...
          <div className="flex gap-5 items-centers justify-center md:justify-start">
            <Link href="/notes" className="py-3 px-5 text-xs md:text-[1rem] md:py-3 md:px-6 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 hover:translate-y-[-2px] transition-all hover:shadow text-nowrap">Browse Subjects</Link>
            <Link href="/past-papers" className="py-3 px-5 text-xs md:text-[1rem] md:py-3 md:px-6 border-2 border-indigo-600 text-indigo-600 rounded-lg font-semibold hover:bg-indigo-400 hover:text-white hover:translate-y-[-2px] transition-all hover:shadow dark:text-gray-300 text-nowrap">View Past Papers</Link>
          </div>
        </div>
      ...
      <section className="my-16">
        <div className="flex justify-between items-center mb-9 px-3">
          ...
          <Link href="/notes" className="text-sm md:text-[1rem] text-indigo-600 font-medium flex items-center py-2 px-4 rounded-lg hover:bg-indigo-400 hover:text-white transition-all">
      ...
      <section className="bg-white rounded-2xl py-5 px-2 md:p-10 shadow border border-gray-200 mx-3 my-16 dark:bg-gray-800 dark:border-gray-700">
        <div className="flex justify-between items-center mb-9">
          <h2 className="text-[16px] md:text-2xl font-semibold text-gray-800 relative after:absolute after:bottom-[-10px] after:left-0 after:w-[60px] after:h-1 after:bg-indigo-600 after:rounded-md dark:text-gray-100">Featured Papers</h2>
          <Link href="/past-papers" className="text-xs md:text-[1rem] text-indigo-600 font-medium flex items-center py-2 px-4 rounded-lg hover:bg-indigo-400 hover:text-white transition-all">
        ...
        {/* <div className="flex flex-wrap gap-4 mb-8">
          <select className="py-3 px-5 border border-gray-200 rounded-lg bg-white min-w-[180px] font-['Poppins'] text-sm transition-all cursor-pointer text-gray-800 focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100
              dark:bg-gray-600 dark:border-gray-500 dark:text-gray-200 w-full md:w-fit ">
          ...
          <select className="py-3 px-5 border border-gray-200 rounded-lg bg-white min-w-[180px] font-['Poppins'] text-sm transition-all cursor-pointer text-gray-800 focus:outline-none focus:border-indigo-600 focus:ring-2 focus:ring-indigo-100 dark:bg-gray-600 dark:border-gray-500 dark:text-gray-200 w-full md:w-fit">
      ...
      <section className="py-10 mx-3 my-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <TestimonialCard
            name="David Googins"
            role="Arts Student"
            testimonial="The arts past papers helped me understand the exam pattern and gave me insight about the topic's most important questions. I wouldn't have scored an A without StudyNotes!"
            src="https://images.pexels.com/photos/1329494/pexels-photo-1329494.jpeg?auto=compress&cs=tinysrgb&w=600"
          />
          <TestimonialCard
            name="Jeff Hardy"
            role="Aerospace Engineering"
            testimonial="The question papers and notes provided here in NoteNest helped me understand the exam pattern. I am really gald that I found this faboulous website right before my exam and It helped me prepare well for my exams!"
