...
export default function PastPapersPage({ subjects }: { subjects: Subject }) {
    ...
    return (
        <div className="min-h-screen min-w-[1080px] bg-gray-50 dark:bg-gray-900">
                ...
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {filteredSubjects.map((subject) => (
                            <Link href={`/admin/past-papers/${subject.name}`}
                                key={subject.id}
                            ...
                            >
                                <div className="p-6">
                                    <h3 className="text-xl font-bold text-indigo-600 dark:text-gray-100 mb-2 capitalize">{subject.name}</h3>
